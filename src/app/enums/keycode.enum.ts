//https://github.com/nfriend/ts-key-enum/blob/master/Key.enum.d.ts
...
export enum KeyCode {
  ...
  /** Erase to End of Field. Deletes all characters from the current cursor offset to the end of the current field. */
  EraseEof = 'EraseEof',
  ...
  /** The Accept, MelchiorCommit, or OK key or button. Accepts the currently selected option or input method sequence conversion. */
  Accept = 'Accept',
